...
<main>
    <!-- hero area start -->
    <div class="tp-contact-main-ptb p-relative include-bg"
                ...
                <div class="col-xl-12">
                    <div class="ar-hero-title-box tp_fade_anim" data-delay=".3">
                        <div class="ar-about-us-4-title-box shape-color  d-flex align-items-center mb-20">
                            <span class="tp-section-subtitle pre tp_fade_anim">Careers</span>
                        ...
                        <h3 class="tp-career-title fs-100 pb-30">Build your future <br>
                            with a team that <br>
                            creates momentum.</h3>
                    </div>
                </div>
                ...
                <div class="row">
                    ...
                    <div class="col-xl-3 col-lg-4">
                        <div class="tp-contact-main-funfact-wrap">
                            <div class="crp-hero-funfact-wrap crp-hero-funfact-bg z-index-1 p-relative tp_fade_anim ar-about-funfact-color"
                                data-delay=".5" data-background="assets/img/home-09/hero/funfact-bg-shape-2.png">
                                ...
                                <div class="ar-about-funfact-item-box mb-35">
                                    <div class="ar-about-funfact-item d-flex align-items-center">
                                        ...
                                        <div class="ar-about-funfact-item-content">
                                            <p>Call HR Directly</p>
                                            <a class="tp-line-white" href="tel:+918080803374">+91 808 080
                                                3374</a>
                                        </div>
                                    </div>
                                    <div class="ar-about-funfact-item d-flex align-items-center">
                                        <div class="ar-about-funfact-item-icon">
                                            <span><svg xmlns="http://www.w3.org/2000/svg" width="21" height="18"
                                    ...
                                    <div class="ar-about-funfact-item d-flex align-items-center">
                                        ...
                                        <div class="ar-about-funfact-item-content">
                                            <a class="tp-line-white" href="contactus.php">Talk To Us</a>
                                        </div>
                                    </div>
                                </div>
                                <div class="ar-about-funfact-item-bottom">
                                    <p>Explore our <span>open roles</span> and <span>team culture</span></p>
                                </div>
                            </div>
                        </div>
                    </div>
                            ...
                            <div
                                ...
                                <div class="tp-contact-location-right">
                                    <div class="tp-contact-location-loc">
                                        <!-- <span class="tp-contact-location-loc-title"></span> -->
                                        <a href="" target="_blank">
                                            Looking for a creative designer to develop attractive graphics, branding,
                                            and digital content.
                                        </a>
                                    </div>
                            ...
                            <div
                                ...
                                <div class="tp-contact-location-right">
                                    <div class="tp-contact-location-loc">
                                        ...
                                        <a href="" target="_blank">Hiring a skilled developer to create and maintain
                        ...
                        <div class="col-xl-5">
                            <div
                                ...
                                <div class="tp-contact-location-right">
                                    <div class="tp-contact-location-loc">
                                        <!-- <span class="tp-contact-location-loc-title">Base Create</span> -->
                                        <a href="" target="_blank">Seeking a marketing executive to manage social media
                                            platforms, campaigns, and online promotions.</a>
                                    </div>
                                    <div class="tp-contact-location-map">
                                        <a href="#">Google Maps</a>
                                    </div>
            ...
            <div class="row">
                <div class="col-lg-5">
                    <div class="tp-contact-form-heading tp_fade_anim mb-50">
                        ...
                        <h3 class="tp-section-title lts">Tell us how <br>
                            you can grow <br>
                            with us.</h3>
                    </div>
                </div>
