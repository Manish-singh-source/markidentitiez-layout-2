...
function mi_log_mail_issue($context, $message)
{
...
function mi_redirect_failure($step, $reason = '')
{
    if ($reason !== '') {
        mi_log_mail_issue($step, $reason);
    }
...
if ($_SERVER['REQUEST_METHOD'] !== 'POST') {
    mi_respond(false, 'Invalid request method.', 'contactus.php');
}
...
$recaptcha_secret = '6LdwUeYsAAAAAPFjoQi9O4BBco2NbpqAVPiynyXH';
...
$recaptcha_curl_error = curl_error($ch);
curl_close($ch);

$recaptcha_decoded = json_decode($recaptcha_result, true);

if ($recaptcha_result === false) {
    mi_log_mail_issue('reCAPTCHA', 'cURL request failed: ' . $recaptcha_curl_error);
    $errors[] = "reCAPTCHA verification failed. Please try again.";
} elseif (empty($recaptcha_decoded['success'])) {
    $errors[] = "reCAPTCHA verification failed. Please try again.";
}
...
if (!$submissionStored) {
    mi_log_mail_issue('Submission store', 'Failed to write contact submission to log file.');
}
                                                            ...
                                                            <tbody>
                                                                <tr>
                                                                    <td valign="middle" align="left" style="width:75%">
                                                                        <img style="display: inline-block; position: relative; max-width: 100%" src="https://localhost/markidentitiez.com/webp-Images/markidentitiez-best-branding-agency-in-kandivali-mumbai-black-logo.webp" width="250px" height="45px" border="0">
                                                                    </td>
                                                                            ...
                                                                            <tbody>
                                                                                <tr>
                                                                                    <td valign="middle" align="left">
                                                                                        <font style="font-size: 12px" color="#333333" face="Arial, Helvetica, sans-serif">
                                                                                            Regards,<br />
                                                                                            Team Mark Identitiez <br />
                                                                                            <span>Email: <a href="mailto:info@markidentitiez.com">info@markidentitiez.com</a></span><br />
                                                                                                            ...
                                                                                                            <tbody>
                                                                                                                <tr>
                                                                                                                    <td valign="middle" align="left">
                                                                                                                        <font style="font-size: 12px" color="#333333" face="Arial, Helvetica, sans-serif">
                                                                                                                            Best Regards,<br />
                                                                                                                            <span>Team Mark Identitiez</span><br />
                                                                                                                            <span>Email: <a href="mailto:info@markidentitiez.com">info@markidentitiez.com</a></span><br />
...
// Send Admin Email
if (!$mail->send()) {
    mi_log_mail_issue('Admin mail', $mail->ErrorInfo);
}

// Client Email Setup
$client_mail = mi_build_mailer();

$client_mail->setFrom('support@technofra.com', 'Mark Identitiez');
$client_mail->addAddress($email);
$client_mail->isHTML(true);
$client_mail->Subject = 'Thank You for Your Enquiry - Mark Identitiez Team (' . $currentDateTime . ')';
$client_mail->Body = $client_htmlbody;

// Send Client Email
if (!$client_mail->send()) {
    mi_log_mail_issue('Client mail', $client_mail->ErrorInfo);
}

mi_respond(true, 'Your message has been submitted successfully.', 'success.php');
